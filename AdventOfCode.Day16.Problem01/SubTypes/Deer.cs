...
internal class Deer
{
    ...
    private Deer(Point location, Directions direction, int points, Moves[] movesHistory)
    {
        Location = location;
        Direction = direction;
        Points = points;
        _movesHistory.AddRange(movesHistory);
    }
    ...
    public Deer GetCopy()
    {
        return new Deer(Location, Direction, Points, GetMovesHistory());
    }
    ...
    public Moves[] GetMovesHistory()
    {
        return _movesHistory.ToArray();
    }

    private readonly List<Moves> _movesHistory = new List<Moves>();
    ...
    private bool GoForward(DeerTrack deerTrack)
    {
        ...
        deerTrack[Location] = TrackUnits.DeerWasHere;
